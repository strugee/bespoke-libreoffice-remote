...
gulp.task('compile', ['clean'], function() {
	return browserify('./lib/bespoke-libreoffice-remote.js')
		.bundle({ standalone: 'bespoke.plugins.libreoffice-remote' })
		.pipe(source('bespoke-libreoffice-remote.js'))
		.pipe(buffer())
		...
		.pipe(gulp.dest('dist'))
		.pipe(rename('bespoke-libreoffice-remote.min.js'))
		.pipe(uglify())
		.pipe(header(template([
			'/*! <%= name %> v<%= version %> ',
